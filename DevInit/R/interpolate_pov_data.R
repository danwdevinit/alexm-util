...
data <- read.csv("C:/git/alexm-util/DevInit/R/poor-people-long.csv", header = TRUE,sep=",",na.strings="",check.names=FALSE)
names <- colnames(data)
data <- interpolateCol(data,"value")
write.csv(data,"poor-people.csv",row.names=FALSE,na="")
