...
parser = OptionParser()
parser.add_option("-i", "--input", dest="input", default="./Central govt/Approved Estimates 2011-12.pdf",
        ...
        for j in range(0,elLen):
            ...
            if el.tag == "text":
                ...
                if not isTableV3:
                    ...
                    if font==55:
                    ...
                    elif font==40 and "Sector" in trytext(el):
                        sector+=1
                        try:
                        ...
                        if j<elLen-8:
                            ...
                            #Pattern is 51 51 52 51 51 52 40 51 51 for:
                            #wage non-wage total wageEst non-wageEst totalEst econFunc NTR NTREst
                            if font2==51 and font3==52 and font4==51 and font5==51 and font6==52 and font7==40 and font8==51 and font9==51:
                                #Wage 2010/11 Approved Budget
                                obj = {}
                                obj['year']="2010/11 Approved Budget"
                                ...
                                obj['ofWhich']=""
                                output.append(obj)
                                #Non-Wage 2010/11 Approved Budget
                                obj = {}
                                obj['year']="2010/11 Approved Budget"
                                obj['Government']="Central Government"
                                obj['sectorId']=sector
                                ...
                                obj['ofWhich']=""
                                output.append(obj)
                                #Wage 2011/12 Approved Estimates
                                obj = {}
                                obj['year']="2011/12 Approved Estimates"
                                obj['Government']="Central Government"
                                obj['sectorId']=sector
                                obj['Vote']=vote
                                obj['Ministry']=ministry
                                ...
                                obj['ofWhich']=""
                                output.append(obj)
                                #Non-Wage 2011/12 Approved Estimates
                                obj = {}
                                obj['year']="2011/12 Approved Estimates"
                                obj['Government']="Central Government"
                                obj['sectorId']=sector
                                ...
                                obj['ofWhich']=""
                                output.append(obj)
                                #NTR 2011/12 Approved Estimates
                                obj = {}
                                obj['year']="2011/12 Approved Estimates"
                                obj['Government']="Central Government"
                                obj['sectorId']=sector
