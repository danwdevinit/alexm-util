...
parser = OptionParser()
parser.add_option("-i", "--input", dest="input", default="./Central govt/Approved Estimates 2009-10.pdf",
                ...
                if not isTableV3:
                    ...
                    if trytext(el)[:13]=="Vote Function":
                        ...
                        if row[0]['text'] not in wrongText and len(row)==5:
                            ...
                            #Save this for later in case it's needed:
                            lastPageOfWhich = metaObj["Economic Function"]
                            #Wage 2009/10 Draft Estimates
                            obj = {}
                            obj['year']="2009/10 Draft Estimates"
                    ...
                    #of which columns
                        ...
                        obj['Economic Function']=metaObj["Economic Function"]
                        obj['Output']=econOutput
                        obj['ofWhich']=trytext(ofWhich) if trytext(ofWhich)!="NTR" else lastPageOfWhich
                        output.append(obj)
                        #Non-Wage 2009/10 Draft Estimates
                        obj = {}
                        obj['year']="2009/10 Draft Estimates"
                        obj['Government']="Central Government"
                        obj['sectorId']=sector
