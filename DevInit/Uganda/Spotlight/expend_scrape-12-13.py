...
parser = OptionParser()
parser.add_option("-i", "--input", dest="input", default="S:/Projects/Programme resources/Data/Data sets/Domestic Government Expenditure/Government budgets/Uganda/2012-13/Budget Estimates/",
...
def main():
        ...
        for i in range(0,pageLen):
            ...
            for j in range(0,elLen):
                ...
                if el.tag == "text":
                    ...
                    if not isTable:
                        if trytext(el)=="Local Government Budget Estimates":
    ...
    with open(options.output+"Expenditure-12-13.csv", 'wb') as output_file:
