...
parser = OptionParser()
parser.add_option("-i", "--input", dest="input", default="S:/Projects/Programme resources/Data/Data sets/Domestic Government Expenditure/Government budgets/Uganda/Missing PDFs/2015-16",
...
def main():
            ...
            for j in range(0,elLen):
                ...
                if el.tag == "text":
                    ...
                    if not isTable:
                        ...
                        elif abs(left-77)<5 or abs(left-68)<5 or abs(left-111)<5 or abs(left-120)<5  or abs(left-84)<5:
    ...
    with open(options.output+"Expenditure-15-16-missing.csv", 'wb') as output_file:
