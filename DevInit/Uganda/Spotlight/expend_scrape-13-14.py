...
parser = OptionParser()
parser.add_option("-i", "--input", dest="input", default="S:/Projects/Programme resources/Data/Data sets/Domestic Government Expenditure/Government budgets/Uganda/2013-14/Budget Estimates/",
...
def main():
    ...
    with open(options.output+"Expenditure-13-14.csv", 'wb') as output_file:
