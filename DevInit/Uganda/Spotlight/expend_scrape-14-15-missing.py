...
parser = OptionParser()
parser.add_option("-i", "--input", dest="input", default="S:/Projects/Programme resources/Data/Data sets/Domestic Government Expenditure/Government budgets/Uganda/Missing PDFs/2014-15/",
...
def main():
        ...
        for i in range(0,pageLen):
            ...
            for j in range(0,elLen):
                ...
                if el.tag == "text":
                    ...
                    if not isTable:
                        if trytext(el)=="Local Government Performance Contract" or trytext(el)=="Local Government Budget Framework Paper":
    ...
    with open(options.output+"Expenditure-14-15-missing.csv", 'wb') as output_file:
